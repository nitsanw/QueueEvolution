...
public final class FFBufferOrdered1<E> extends L3Pad<E> implements Queue<E> {
    ...
    public FFBufferOrdered1(final int capacity) {
        super(capacity);
    }
    ...
    public boolean offer(final E e) {
        ...
        UnsafeAccess.UNSAFE.putOrderedLong(this, TAIL_OFFSET, tail+1);
        return true;
    }
    ...
    public E poll() {
        ...
        UnsafeAccess.UNSAFE.putOrderedLong(this, HEAD_OFFSET, head+1);
        return e;
    }
