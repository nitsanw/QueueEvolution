...
import psy.lob.saw.queues.BackOffStrategy;
 ...
 * </ul>
 */
public final class MPSCQueue32<E> extends MPSCQueueL3Pad<E> implements Queue<E> {
	private static final BackOffStrategy CAS_BACKOFF = BackOffStrategy.getStrategy("cas.backoff", BackOffStrategy.SPIN);
    public MPSCQueue32(final int capacity) {
        super(capacity);
    }
