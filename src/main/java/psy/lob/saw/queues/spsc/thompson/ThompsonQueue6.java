...
abstract class ThompsonQueue6L0Pad<E> extends AbstractQueue<E>{
    protected long p00, p01, p02, p03, p04, p05, p06, p07;
    protected long p10, p11, p12, p13, p14, p15, p16, p17;
}

abstract class ThompsonQueue6Fields<E> extends ThompsonQueue6L0Pad<E> {
    protected static final int BUFFER_PAD = 32;
    protected static final int SPARSE_SHIFT = Integer.getInteger("sparse.shift", 0);
    protected final int capacity;
    protected final long mask;
    protected final E[] buffer;
    protected final VolatileLongDCell tail = new VolatileLongDCell(0);
    protected final VolatileLongDCell head = new VolatileLongDCell(0);

    protected final LongDCell tailCache = new LongDCell();
    protected final LongDCell headCache = new LongDCell();

    @SuppressWarnings("unchecked")
    ThompsonQueue6Fields(int capacity) {
...
public final class ThompsonQueue6<E> extends ThompsonQueue6Fields<E> implements
        Queue<E> {
    protected long p00, p01, p02, p03, p04, p05, p06, p07;
    ...
    public ThompsonQueue6(final int capacity) {
        super(capacity);
    }
