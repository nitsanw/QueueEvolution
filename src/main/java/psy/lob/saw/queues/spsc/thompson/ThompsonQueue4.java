 ...
 * </ul>
 */
abstract class ThompsonQueue4P0<E> extends AbstractQueue<E> {
	long p00, p01, p02, p03, p04, p05, p06, p07;
}

abstract class ThompsonQueue4Fields<E> extends ThompsonQueue4P0<E> {
	...
	public ThompsonQueue4Fields(int capacity) {
...
public final class ThompsonQueue4<E> extends ThompsonQueue4Fields<E> implements Queue<E> {
	long p10, p11, p12, p13, p14, p15, p16, p17, p18;

	public ThompsonQueue4(final int capacity) {
		super(capacity);
	}
