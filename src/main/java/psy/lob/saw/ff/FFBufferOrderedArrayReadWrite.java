...
final public class FFBufferOrderedArrayReadWrite<T> extends AbstractQueue<T> implements Queue<T> {
    ...
    public FFBufferOrderedArrayReadWrite(int sizeByPowerOfTwo, int pow) {
